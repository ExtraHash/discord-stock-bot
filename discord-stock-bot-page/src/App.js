    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                <p className="miniHeaderText">
                    A Discord Bot for Stock/Options Trading Groups
                </p>
            </header>
            <body>
                <div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            Query charts for any stock, index, or equity! You
                            can query for particular time interval, chart types,
                            and even automatically include indicators and
                            trendlines.
                            <br />
                            <br />
                            For a list of all supported indicators and time
                            interval syntax, make sure to check out the Github
                            page
                        </div>
                    </div>
                    <div
